...
parser.add_argument('--tmp_data_dir', type=str, default='/home/jwmun', help='temp data dir')
...
def main():
    ...
    traindir = os.path.join(data_dir, 'img_train')
    validdir = os.path.join(data_dir, 'img_val')
